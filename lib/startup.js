...
function tuiCommand() {
  return new Command()
    ...
    .option('-p, --preset <id>', 'agent preset for a new session (standard, code, minimal, cordis; auto/audit when installed)')
...
Examples:
  ...
  dsh --profile tui --preset audit start with independent Audit review
